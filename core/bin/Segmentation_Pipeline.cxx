...
if (check_black_image(image_detect.c_str(),10,40)==true){std::cout<<" No SCAR tissue..."<<std::endl;}
	...
	if (segmentation_part=="scar"){threshold_portion=RGMM_fwhm;}
	...
	std::cout<<" FWHM between them: "<<threshold_portion<<std::endl;
	...
	BI2->Image_binary((root+"portion_image.jpg").c_str(),(root+"binary_portion_image.jpg").c_str(), 20,255);
